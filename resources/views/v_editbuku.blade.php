...
<div class="col-sm-6">
    <div class="form-group">
       <label>ID</label>
       <input name="id_buku" class="form-control" value="{{ $buku->id_buku }}" readonly>
    ...
    <div class="form-group">
       ...
       <input name="kategori" class="form-control" value="{{ $buku->kategori }}">
       <div class="text-danger">
        @error('kategori')
            {{ $message }}
        @enderror
    ...
    <div class="form-group">
       <label>Penulis</label>
       <input name="penulis" class="form-control" value="{{ $buku->penulis }}">
       <div class="text-danger">
        @error('penulis')
            {{ $message }}
        @enderror
    ...
    <div class="col-sm 12">
        <div class="col-sm-6">
            <img src="{{ url('foto_buku/'.$buku->foto_buku) }}" width="100px" alt="">
        </div>
        <div class="col-sm-6">
            <div class="form-group">
